...
def fkin(q):
    x = np.array([-np.sin(q[0]) * (np.cos(q[1]) + np.cos(q[1] + q[2])),
    		  np.cos(q[0]) * (np.cos(q[1]) + np.cos(q[1] + q[2])),
    		  np.sin(q[1]) + np.sin(q[1] + q[2])])
...
def Jac(q):
    ...
    val_11 = -np.cos(q[0]) * (np.cos(q[1]) + np.cos(q[1] + q[2]))
    val_12 = np.sin(q[0]) * (np.sin(q[1]) + np.sin(q[1] + q[2]))
    val_13 = np.sin(q[0]) * np.sin(q[1] + q[2])
    
    val_21 = -np.sin(q[0]) * (np.cos(q[1]) + np.cos(q[1] + q[2]))
    val_22 = -np.cos(q[0]) * (np.sin(q[1]) + np.sin(q[1] + q[2]))
    val_23 = -np.cos(q[0]) * np.sin(q[1] + q[2])
    
    val_31 = 0
    val_32 = np.cos(q[1]) + np.cos(q[1] + q[2])
    val_33 = np.cos(q[1] + q[2])
    
    J = np.array([[val_11, val_12, val_13],
